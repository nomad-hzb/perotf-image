...
```sh
curl -L -o nomad-oasis.zip "https://github.com/nomad-hzb/perotf-image/raw/main/nomad-oasis.zip"
```
 ...
 *I get an* `Error response from daemon: Head "https://ghcr.io/v2/nomad-hzb/perotf-image/manifests/main": unauthorized`
