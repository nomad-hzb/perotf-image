![docker image](https://github.com/nomad-hzb/perotf-image/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/nomad-hzb/perotf-image.git
    cd perotf-image
    ```
    ...
    ```sh
    curl-L -o perotf-image.zip "https://github.com/nomad-hzb/perotf-image/archive/main.zip"
    unzip perotf-image.zip
    cd perotf-image
    ```
...
your `docker-compose.yaml` with `ghcr.io/nomad-hzb/perotf-image:main` for the services
...
```
docker pull ghcr.io/nomad-hzb/perotf-image/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/nomad-hzb/perotf-image/manifests/main": unauthorized`
